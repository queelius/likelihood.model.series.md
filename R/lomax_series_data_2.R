...
#' sets that model m0
#'
#' Masked data containing the system lifetime and other attributes of 2000
#' series system with parameters \code{lambda=c(1,1.5,.75)} and \code{kappa=c(2,1.5,2.5)}. Every candidate
#' set (of model m0) has \code{w=2} candidate nodes.
#'
...
#' }
#' @source \url{https://github.com/queelius/masked.data/blob/master/data-raw/lomax_series_data_2_gen.R}
"lomax_series_data_2"

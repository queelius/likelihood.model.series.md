#' Masked data for a 3-out-of-3 (series) system with exponentially distributed
#' nodes.
#'
#' Masked data containing the system lifetime and other attributes of 250
#' series parameterized by \code{theta=c(2,4,8)} and candidate model m0.
#' Candidate set sizes were randomly drawn from \code{{1,2,3}}. The seed for
#' the PRNG is 1233445.
#'
#' @format A data frame with 100000 rows and 13 variables:
#' \describe{
...
#' }
#' @source \url{https://github.com/queelius/masked.data/blob/master/data-raw/exp_series_data_5_gen.R}
"exp_series_data_5"

...
structures = list()
structures[hash(which.min)] = "series"
structures["series"] = hash(which.min)
structures[hash(which.max)] = "parallel"
structures["parallel"] = hash(which.max)

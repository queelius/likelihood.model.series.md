...
#'   \item{c.1}{Boolean observable variable, c.1 TRUE indicates nodes 1 is in candidate set}
#'   \item{c.2}{Boolean observable variable, c.2 TRUE indicates nodes 2 is in candidate set}
#'   \item{c.3}{Boolean observable variable, c.3 TRUE indicates nodes 3 is in candidate set}
#' }

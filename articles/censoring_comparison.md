...
2.  **Interval-censoring outperforms one-sided censoring.**
    Configuration D, which includes interval-censored observations from
    periodic inspection, achieves lower MSE than configurations B or C,
    which use only right- or left-censoring. Interval-censoring brackets
    the failure time from both sides, preserving more information.

3.  **Left and right censoring are comparably informative** for the
    exponential model. Configurations B and C produce similar MSE
    values. This is a consequence of the memoryless property: knowing
    $T > \tau$ and knowing $T < \tau$ are symmetric information losses
...
|:----------------------|---------:|:----------------------|
| Exponential           |    0.092 | Closed-form           |
| Homogeneous Weibull   |    0.112 | Closed-form           |
| Heterogeneous Weibull |    0.745 | Numerical integration |

...
Install the library and other dependent packages with:
...
Once installed, you may load these libraries with:
```{r setup,message=F}
library(devtools)
...
print(md_bernoulli_candidate_C1_C2_C3)
```
...
md <- md %>% md_bernoulli_candidate_C1_C2_C3(m, function(n) rep(.5,n))
print(md)
```
